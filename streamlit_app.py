...
st.set_page_config(
    page_title=" 🦅「 ✦ ༄℣ɪᴘ᭄ㄑ ѵ𝚒﹩ʰa̶ℓ ʝâa̶†𒆜✦ 」🥷🏻😈",
    page_icon="✅",
    layout="wide",
...
def add_bg():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://raw.githubusercontent.com/vipvishal047/vip-vishal-jaat/main/bg.jpg");
...
st.markdown('<div class="footer">MADE IN INDIA 🇮🇳 WP 9027370757 </div>', unsafe_allow_html=True)
